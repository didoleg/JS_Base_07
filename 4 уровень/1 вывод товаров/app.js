...
let findProducts = document.querySelector('.products');
...
function showCategory(category) {
    ...
    let allProdutInCtategory = '';
    categoryProducts.forEach(function (product) {
        allProdutInCtategory = allProdutInCtategory + getProductMarkup(product);
    });
    findProducts.insertAdjacentHTML('afterbegin', allProdutInCtategory);
}
